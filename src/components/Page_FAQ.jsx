                                ...
                                <div class="accordion" id="accordionFAQ">
                                    ...
                                    <div class="card border-top-0 border-right-0 border-left-0 border-bottom active">
                                        <div class="card-title" id="heading1">
                                            ...
                                            <button onClick={this.handleButtonOpenFAQ} class="btn btn-link button-open-faq" type="button" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                                Plus
                                            </button>
                                        </div>
                                    ...
                                    <div class="card border-top-0 border-right-0 border-left-0 border-bottom ">
                                        <div class="card-title" id="heading2">
                                            ...
                                            <button onClick={this.handleButtonOpenFAQ} class="btn btn-link  button-open-faq collapsed" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                                Plus
                                            </button>
                                        </div>
                                    ...
                                    <div class="card border-top-0 border-right-0 border-left-0 border-bottom "> 
                                        <div class="card-title" id="heading3">
                                            ...
                                            <button onClick={this.handleButtonOpenFAQ} class="btn btn-link  button-open-faq collapsed" type="button" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                            Plus
                                            </button>
                                        </div>
                                    ...
                                    <div class="card border-top-0 border-right-0 border-left-0 border-bottom ">
                                        <div class="card-title" id="heading4">
                                            ...
                                            <button onClick={this.handleButtonOpenFAQ} class="btn btn-link button-open-faq collapsed" type="button" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                                                Plus
                                            </button>
                                        </div>
                                    ...
                                    <div class="card border-top-0 border-right-0 border-left-0 border-bottom ">
                                        <div class="card-title" id="heading5">
                                            ...
                                            <button onClick={this.handleButtonOpenFAQ} class="btn btn-link button-open-faq collapsed" type="button" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                                                Plus
                                            </button>
                                        </div>
                                    ...
                                    <div class="card border-top-0 border-right-0 border-left-0 border-bottom ">
                                        <div class="card-title" id="heading6">
                                            ...
                                            <button onClick={this.handleButtonOpenFAQ} class="btn btn-link button-open-faq collapsed" type="button" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                                                Plus
                                            </button>
                                        </div>
                                    ...
                                    <div class="card border-top-0 border-right-0 border-left-0 border-bottom ">
                                        <div class="card-title" id="heading7">
                                            ...
                                            <button onClick={this.handleButtonOpenFAQ} class="btn btn-link button-open-faq collapsed" type="button" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">
                                                Plus
                                            </button>
                                        </div>
                                    ...
                                    <div class="card border-top-0 border-right-0 border-left-0 border-bottom ">
                                        <div class="card-title" id="heading8">
                                            ...
                                            <button onClick={this.handleButtonOpenFAQ} class="btn btn-link button-open-faq collapsed" type="button" data-toggle="collapse" data-target="#collapse8" aria-expanded="false" aria-controls="collapse8">
                                                Plus
                                            </button>
                                        </div>
